#!/bin/sh
if [ ! -f alpine-minirootfs-3.13.2-$ARCH.tar.gz ]; then
    wget https://dl-cdn.alpinelinux.org/alpine/v3.13/releases/$ARCH/alpine-minirootfs-3.13.2-$ARCH.tar.gz
fi
...
mount vda.img mnt
cd mnt
tar xf ../alpine-minirootfs-3.13.2-$ARCH.tar.gz
